...
public class Entity1stClassRheingoldKitchenChristmas extends AbstractWorkCart {

    public Entity1stClassRheingoldKitchenChristmas(World world) {
        super(world);
    ...
    public void onRenderInsertRecord() {
        Traincraft.traincraftRegistry.RegisterRollingStockModel(
                new TrainRenderRecord(wwcp.common.library.Info.modID,
                        Entity1stClassRheingoldKitchenChristmas.class, new ChristmasSpeise1(),
                        "ChristmasSpeise1",
                    ...
                    public ResourceLocation getTextureFile(String colorAsString) {
                        ...
                        switch (colorAsString.toLowerCase()) {
                            case "yellow":
                                texturePath = "textures/passengerstock/ChristmasStock/ChristmasSpeise1";
                                break;
                        }
                        texturePath += ".png";
