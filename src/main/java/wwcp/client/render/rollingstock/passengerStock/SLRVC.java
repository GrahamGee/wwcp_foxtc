...
public class SLRVC extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[135] = new ModelRendererTurbo(this, 41, 154, textureX, textureY); // Right Exterior Rollsign
		bodyModel[136] = new ModelRendererTurbo(this, 41, 154, textureX, textureY); // Right Interior Rollsign
		bodyModel[137] = new ModelRendererTurbo(this, 201, 157, textureX, textureY); // Box 422
		bodyModel[138] = new ModelRendererTurbo(this, 41, 154, textureX, textureY); // Left Interior Rollsign
		bodyModel[139] = new ModelRendererTurbo(this, 41, 154, textureX, textureY); // Left Exterior Rollsign
		...
		bodyModel[148] = new ModelRendererTurbo(this, 346, 104, textureX, textureY); // Box 383
		bodyModel[149] = new ModelRendererTurbo(this, 13, 156, textureX, textureY); // Box 117
		bodyModel[150] = new ModelRendererTurbo(this, 13, 156, textureX, textureY); // Box 117
		bodyModel[151] = new ModelRendererTurbo(this, 13, 156, textureX, textureY); // Box 117
		bodyModel[152] = new ModelRendererTurbo(this, 13, 156, textureX, textureY); // Box 117
		bodyModel[153] = new ModelRendererTurbo(this, 27, 214, textureX, textureY); // Interior Light Bar
		bodyModel[154] = new ModelRendererTurbo(this, 27, 214, textureX, textureY); // Interior Light Bar

		bodyModel[0].addBox(0F, 0F, 0F, 14, 1, 7, 0F); // Box 0
		bodyModel[0].setRotationPoint(-33F, 3.5F, -10F);

		bodyModel[1].addShapeBox(0F, 0F, 0F, 5, 4, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -4F, 0F); // Box 51
		bodyModel[1].setRotationPoint(-29F, 4.5F, -10F);

		bodyModel[2].addBox(0F, 0F, 0F, 20, 4, 1, 0F); // Box 50
		bodyModel[2].setRotationPoint(-24F, 4.5F, 9F);
		...
		bodyModel[3].setRotationPoint(-33F, -11.5F, -10F);
		...
		bodyModel[4].setRotationPoint(-33F, -12.5F, -10F);
		...
		bodyModel[6].setRotationPoint(-33F, -12.5F, 9F);
		...
		bodyModel[7].setRotationPoint(28F, -16.5F, -9.5F);
		...
		bodyModel[8].setRotationPoint(28F, -16.5F, 8.5F);
		...
		bodyModel[9].setRotationPoint(-31F, -16.5F, -9.5F);
		...
		bodyModel[10].setRotationPoint(-31F, -16.5F, 8.5F);
		...
		bodyModel[11].setRotationPoint(-28F, -16.5F, -9.5F);
		...
		bodyModel[12].setRotationPoint(-28F, -16.5F, 8.5F);
		...
		bodyModel[13].setRotationPoint(0F, -10.5F, -9.5F);
		...
		bodyModel[25].setRotationPoint(4F, -11.5F, -10F);
		...
		bodyModel[26].setRotationPoint(-33F, -11.5F, 9F);
		...
		bodyModel[27].setRotationPoint(4F, -11.5F, 9F);

		bodyModel[28].addBox(0F, 0F, 0F, 8, 1, 1, 0F); // Box 370
		bodyModel[28].setRotationPoint(-4F, -11.5F, -10F);

		bodyModel[29].addBox(0F, 0F, 0F, 8, 1, 1, 0F); // Box 370
		bodyModel[29].setRotationPoint(-4F, -11.5F, 9F);
		...
		bodyModel[30].setRotationPoint(0F, -10.5F, 9.5F);
		...
		bodyModel[31].setRotationPoint(-4F, -10.5F, 9.5F);
		...
		bodyModel[32].setRotationPoint(-16F, 6F, -3F);
		...
		bodyModel[33].setRotationPoint(-18F, 4.5F, -3F);

		bodyModel[34].addBox(0F, 0F, 0F, 14, 1, 7, 0F); // Box 0
		bodyModel[34].setRotationPoint(-33F, 3.5F, 3F);

		bodyModel[35].addBox(0F, 0F, 0F, 15, 1, 6, 0F); // Box 0
		bodyModel[35].setRotationPoint(-33F, 3.5F, -3F);

		bodyModel[36].addBox(0F, 0F, 0F, 14, 1, 7, 0F); // Box 0
		bodyModel[36].setRotationPoint(19F, 3.5F, 3F);
		...
		bodyModel[37].setRotationPoint(14F, 6F, -3F);
		...
		bodyModel[38].setRotationPoint(16F, 4.5F, -3F);

		bodyModel[39].addBox(0F, 0F, 0F, 14, 1, 7, 0F); // Box 0
		bodyModel[39].setRotationPoint(19F, 3.5F, -10F);
		...
		bodyModel[40].setRotationPoint(24F, 4.5F, -10F);

		bodyModel[41].addBox(0F, 0F, 0F, 15, 1, 6, 0F); // Box 0
		bodyModel[41].setRotationPoint(18F, 3.5F, -3F);
		...
		bodyModel[42].setRotationPoint(33F, -11.5F, -8F);
		...
		bodyModel[43].setRotationPoint(33F, -11.5F, 3F);

		bodyModel[44].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[44].setRotationPoint(14F, 5.5F, -9F);

		bodyModel[45].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[45].setRotationPoint(18F, 1.5F, -9F);

		bodyModel[46].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[46].setRotationPoint(14F, 5.5F, 3F);

		bodyModel[47].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[47].setRotationPoint(18F, 1.5F, 3F);

		bodyModel[48].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[48].setRotationPoint(23F, 1.5F, -9F);

		bodyModel[49].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[49].setRotationPoint(27F, -2.5F, -9F);

		bodyModel[50].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[50].setRotationPoint(23F, 1.5F, 3F);

		bodyModel[51].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[51].setRotationPoint(27F, -2.5F, 3F);
		...
		bodyModel[52].setRotationPoint(19F, -2.5F, -9F);

		bodyModel[53].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[53].setRotationPoint(-18F, 5.5F, 3F);

		bodyModel[54].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[54].setRotationPoint(-19F, 1.5F, 3F);

		bodyModel[55].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[55].setRotationPoint(-18F, 5.5F, -9F);

		bodyModel[56].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[56].setRotationPoint(-19F, 1.5F, -9F);

		bodyModel[57].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[57].setRotationPoint(-27F, 1.5F, 3F);

		bodyModel[58].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[58].setRotationPoint(-28F, -2.5F, 3F);

		bodyModel[59].addBox(0F, 0F, 0F, 4, 1, 6, 0F); // Box 138
		bodyModel[59].setRotationPoint(-27F, 1.5F, -9F);

		bodyModel[60].addBox(0F, 0F, 0F, 1, 5, 6, 0F); // Box 138
		bodyModel[60].setRotationPoint(-28F, -2.5F, -9F);
		...
		bodyModel[61].setRotationPoint(-6F, 0.5F, -9F);
		...
		bodyModel[62].setRotationPoint(-6F, -11.5F, -9F);
		...
		bodyModel[63].setRotationPoint(-6F, -4.5F, -9.5F);
		...
		bodyModel[64].setRotationPoint(-6F, 0.5F, 4F);
		...
		bodyModel[65].setRotationPoint(-6F, -11.5F, 4F);
		...
		bodyModel[66].setRotationPoint(-6F, -4.5F, 3.5F);
		...
		bodyModel[67].setRotationPoint(4.5F, 0.5F, -9F);
		...
		bodyModel[68].setRotationPoint(4.5F, -11.5F, -9F);
		...
		bodyModel[69].setRotationPoint(4.5F, -4.5F, -9.5F);
		...
		bodyModel[70].setRotationPoint(4.5F, 0.5F, 4F);
		...
		bodyModel[71].setRotationPoint(4.5F, -11.5F, 4F);
		...
		bodyModel[72].setRotationPoint(4.5F, -4.5F, 3.5F);
		...
		bodyModel[73].setRotationPoint(-15F, 0F, 2.5F);
		...
		bodyModel[74].setRotationPoint(-15F, 0F, -3F);
		...
		bodyModel[75].setRotationPoint(-20F, -2.5F, 2.5F);
		...
		bodyModel[76].setRotationPoint(-20F, -2.5F, -3F);
		...
		bodyModel[77].setRotationPoint(16.5F, -2.5F, 2.5F);
		...
		bodyModel[78].setRotationPoint(18.5F, -2.5F, -3F);
		...
		bodyModel[79].setRotationPoint(19F, -2.5F, 3F);
		...
		bodyModel[80].setRotationPoint(-19.5F, -2.5F, -9F);
		...
		bodyModel[81].setRotationPoint(-19.5F, -2.5F, 3F);
		...
		bodyModel[82].setRotationPoint(-19.5F, -11.5F, 4F);
		...
		bodyModel[83].setRotationPoint(-19.5F, -11.5F, -4.5F);
		...
		bodyModel[84].setRotationPoint(5.5F, -11.5F, 4F);
		...
		bodyModel[85].setRotationPoint(5.5F, -11.5F, -4.5F);
		...
		bodyModel[86].setRotationPoint(19F, -3.5F, -7.5F);
		...
		bodyModel[87].setRotationPoint(19F, -9.5F, -7.5F);
		...
		bodyModel[88].setRotationPoint(19F, -10.5F, -9F);
		...
		bodyModel[89].setRotationPoint(-19.5F, -3.5F, -7.5F);
		...
		bodyModel[90].setRotationPoint(-19.5F, -9.5F, -7.5F);
		...
		bodyModel[91].setRotationPoint(-19.5F, -10.5F, -9F);
		...
		bodyModel[92].setRotationPoint(-20F, -3.5F, 2.5F);
		...
		bodyModel[93].setRotationPoint(-20F, -9.5F, 2.5F);
		...
		bodyModel[94].setRotationPoint(-20F, -10.5F, 4F);
		...
		bodyModel[95].setRotationPoint(18.5F, -3.5F, 2.5F);
		...
		bodyModel[96].setRotationPoint(18.5F, -9.5F, 2.5F);
		...
		bodyModel[97].setRotationPoint(18.5F, -10.5F, 4F);
		...
		bodyModel[98].setRotationPoint(19F, -12.5F, -9F);
		...
		bodyModel[99].setRotationPoint(19F, -12.5F, -0.5F);
		...
		bodyModel[100].setRotationPoint(-19.5F, -12.5F, -9F);
		...
		bodyModel[101].setRotationPoint(-19.5F, -12.5F, -0.5F);
		...
		bodyModel[102].setRotationPoint(-19F, -3F, -7.5F);
		...
		bodyModel[103].setRotationPoint(-19F, -3F, -2F);
		...
		bodyModel[104].setRotationPoint(-16.5F, -2F, -2F);
		...
		bodyModel[105].setRotationPoint(-16.5F, -2F, -7.5F);
		...
		bodyModel[106].setRotationPoint(13.5F, 0F, 2.5F);
		...
		bodyModel[107].setRotationPoint(13.5F, 0F, -3F);
		...
		bodyModel[108].setRotationPoint(16F, -3F, 2.5F);
		...
		bodyModel[109].setRotationPoint(16F, -3F, -3F);
		...
		bodyModel[110].setRotationPoint(13.5F, -2F, -3F);
		...
		bodyModel[111].setRotationPoint(13.5F, -2F, 2.5F);

		bodyModel[112].addBox(0F, 0F, 0F, 23, 4, 16, 0F); // Box 103
		bodyModel[112].setRotationPoint(-20.5F, -16F, -8F);
		...
		bodyModel[113].setRotationPoint(6F, 0.5F, -10.91F);
		...
		bodyModel[114].setRotationPoint(-20F, -1.5F, -10.95F);
		...
		bodyModel[115].setRotationPoint(-20F, -1.5F, 9.05F);
		...
		bodyModel[116].setRotationPoint(-24F, 3.5F, -10.95F);
		...
		bodyModel[117].setRotationPoint(-24F, 3.5F, 9.05F);
		...
		bodyModel[118].setRotationPoint(19F, -1.5F, 9.95F);
		...
		bodyModel[119].setRotationPoint(19F, -1.5F, -10.05F);
		...
		bodyModel[120].setRotationPoint(23F, 3.5F, 9.95F);
		...
		bodyModel[121].setRotationPoint(23F, 3.5F, -10.05F);
		...
		bodyModel[122].setRotationPoint(-18F, 0.5F, 9.01F);
		...
		bodyModel[123].setRotationPoint(-29F, 4.5F, 9F);
		...
		bodyModel[124].setRotationPoint(24F, 4.5F, 9F);

		bodyModel[125].addBox(0F, 0F, 0F, 1, 4, 18, 0F); // Box 131
		bodyModel[125].setRotationPoint(-22F, 4.5F, -9F);

		bodyModel[126].addBox(0F, 0F, 0F, 1, 4, 18, 0F); // Box 131
		bodyModel[126].setRotationPoint(21F, 4.5F, -9F);
		...
		bodyModel[127].setRotationPoint(-16.5F, -11.5F, 7F);
		...
		bodyModel[128].setRotationPoint(-14.5F, -11.5F, 7F);
		...
		bodyModel[129].setRotationPoint(-7.5F, -11.5F, 7F);
		...
		bodyModel[130].setRotationPoint(-15F, -7.5F, 7F);
		...
		bodyModel[131].setRotationPoint(6.5F, -11.5F, -9.5F);
		...
		bodyModel[132].setRotationPoint(7.5F, -11.5F, -9.5F);
		...
		bodyModel[133].setRotationPoint(15.5F, -11.5F, -9.5F);
		...
		bodyModel[134].setRotationPoint(8F, -7.5F, -9.5F);

		bodyModel[135].addShapeBox(0F, 0F, 0F, 46, 9, 1, 0F,0F, -7F, -0.95F, -38F, -7F, -0.95F, -38F, -7F, 0F, 0F, -7F, 0F, 0F, 0F, -0.95F, -38F, 0F, -0.95F, -38F, 0F, 0F, 0F, 0F, 0F); // Right Exterior Rollsign
		bodyModel[135].setRotationPoint(7.5F, -17F, -10.99F);

		bodyModel[136].addShapeBox(0F, 0F, 0F, 46, 9, 1, 0F,0F, -7F, -0.95F, -38F, -7F, -0.95F, -38F, -7F, 0F, 0F, -7F, 0F, 0F, 0F, -0.95F, -38F, 0F, -0.95F, -38F, 0F, 0F, 0F, 0F, 0F); // Right Interior Rollsign
		bodyModel[136].setRotationPoint(7.5F, -17F, -8.49F);
		...
		bodyModel[137].setRotationPoint(7.5F, -10.5F, -10F);

		bodyModel[138].addShapeBox(0F, 0F, 0F, 46, 9, 1, 0F,0F, -7F, -0.95F, -38F, -7F, -0.95F, -38F, -7F, 0F, 0F, -7F, 0F, 0F, 0F, -0.95F, -38F, 0F, -0.95F, -38F, 0F, 0F, 0F, 0F, 0F); // Left Interior Rollsign
		bodyModel[138].setRotationPoint(-15.5F, -17F, 6.51F);

		bodyModel[139].addShapeBox(0F, 0F, 0F, 46, 9, 1, 0F,0F, -7F, -0.95F, -38F, -7F, -0.95F, -38F, -7F, 0F, 0F, -7F, 0F, 0F, 0F, -0.95F, -38F, 0F, -0.95F, -38F, 0F, 0F, 0F, 0F, 0F); // Left Exterior Rollsign
		bodyModel[139].setRotationPoint(-15.5F, -17F, 9.09F);
		...
		bodyModel[140].setRotationPoint(-15.5F, -10.5F, 7.5F);

		bodyModel[141].addBox(0F, 0F, 0F, 5, 15, 1, 0F); // Box 5
		bodyModel[141].setRotationPoint(33F, -11.5F, -9F);

		bodyModel[142].addBox(0F, 0F, 0F, 5, 15, 1, 0F); // Box 383
		bodyModel[142].setRotationPoint(33F, -11.5F, 8F);

		bodyModel[143].addBox(0F, 0F, 0F, 5, 1, 16, 0F); // Box 5
		bodyModel[143].setRotationPoint(33F, 3.5F, -8F);
		...
		bodyModel[144].setRotationPoint(33F, 3.5F, -9F);
		...
		bodyModel[145].setRotationPoint(33F, 3.5F, 8F);
		...
		bodyModel[146].setRotationPoint(36F, 3.5F, -9F);
		...
		bodyModel[147].setRotationPoint(36F, 3.5F, 8F);

		bodyModel[148].addBox(0F, 0F, 0F, 5, 1, 18, 0F); // Box 383
		bodyModel[148].setRotationPoint(33F, -12.5F, -9F);

		bodyModel[149].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 1F, 0F, -0.9F, 3F, 1F, 0F, -2F, 1F, 0F, -2F, 1F, -0.9F, 3F, 1F, -0.9F); // Box 117
		bodyModel[149].setRotationPoint(20F, -1.5F, 9.91F);

		bodyModel[150].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 1F, 0F, -0.9F, 3F, 1F, 0F, -2F, 1F, 0F, -2F, 1F, -0.9F, 3F, 1F, -0.9F); // Box 117
		bodyModel[150].setRotationPoint(20F, -1.5F, -10.01F);

		bodyModel[151].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, -0.9F, 1F, 0F, -0.9F, 1F, 0F, 0F, 0F, 0F, 0F, -2F, 1F, -0.9F, 3F, 1F, -0.9F, 3F, 1F, 0F, -2F, 1F, 0F); // Box 117
		bodyModel[151].setRotationPoint(-21F, -1.5F, 9.01F);

		bodyModel[152].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, -0.9F, 1F, 0F, -0.9F, 1F, 0F, 0F, 0F, 0F, 0F, -2F, 1F, -0.9F, 3F, 1F, -0.9F, 3F, 1F, 0F, -2F, 1F, 0F); // Box 117
		bodyModel[152].setRotationPoint(-21F, -1.5F, -10.91F);

		bodyModel[153].addShapeBox(0F, 0F, 0F, 66, 1, 2, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Interior Light Bar
		bodyModel[153].setRotationPoint(-33F, -12F, 5F);

		bodyModel[154].addShapeBox(0F, 0F, 0F, 66, 1, 2, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Interior Light Bar
		bodyModel[154].setRotationPoint(-33F, -12F, -7F);
	}

	SLRV_Bogey frontBogie = new SLRV_Bogey();
	SLRV_Bogey2 backBogie = new SLRV_Bogey2();
